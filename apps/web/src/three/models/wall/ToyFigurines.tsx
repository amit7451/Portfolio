...
export function ZenitsuFigurine({ position = [0, 0, 0] as [number, number, number] }) {
  return (
    <group position={position} scale={[0.4, 0.4, 0.4]}>
      ...
      <mesh position={[0.06, 1.0, 0]} rotation={[0, 0, 0.5]}>
      ...
      {/* Sword */}
      <mesh position={[-0.12, 0.5, 0]} rotation={[0, 0, -0.2]}>
...
export function SpiderManFigurine({ position = [0, 0, 0] as [number, number, number] }) {
  return (
    <group position={position} scale={[0.4, 0.4, 0.4]}>
      ...
      {/* Spider emblem */}
      <mesh position={[0, 0.68, 0.065]}>
        <boxGeometry args={[0.08, 0.06, 0.01]} />
        <meshLambertMaterial color="#1a1a1a" />
      </mesh>
      
      {/* Arms - red */}
      <mesh position={[-0.14, 0.7, 0]} rotation={[0, 0, 0.5]}>
...
export function IronManFigurine({ position = [0, 0, 0] as [number, number, number] }) {
  return (
    <group position={position} scale={[0.4, 0.4, 0.4]}>
      ...
      {/* Arc reactor */}
      <mesh position={[0, 0.7, 0.075]} rotation={[Math.PI / 2, 0, 0]}>
...
export function CaptainAmericaFigurine({ position = [0, 0, 0] as [number, number, number] }) {
  return (
    <group position={position} scale={[0.4, 0.4, 0.4]}>
      ...
      {/* Star emblem */}
      <mesh position={[0, 0.7, 0.065]} rotation={[Math.PI / 2, 0, Math.PI / 10]}>
      ...
      {/* Shield on arm */}
      <mesh position={[-0.22, 0.65, 0]} rotation={[0, Math.PI / 2, 0]}>
        <cylinderGeometry args={[0.12, 0.12, 0.03, 24]} />
        <meshLambertMaterial color="#dc2626" />
      </mesh>
      <mesh position={[-0.24, 0.65, 0]} rotation={[0, Math.PI / 2, 0]}>
        <cylinderGeometry args={[0.08, 0.08, 0.02, 24]} />
        <meshLambertMaterial color="#ffffff" />
      </mesh>
      <mesh position={[-0.25, 0.65, 0]} rotation={[0, Math.PI / 2, 0]}>
      ...
      {/* Wings on helmet */}
      <mesh position={[0.1, 0.98, 0]} rotation={[0, 0, -0.3]}>
