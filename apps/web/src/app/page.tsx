...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        {/* 3D Building Scene ΓÇö scroll-driven camera animation */}
        <BuildingScene />
      </main>

      {/* Rentra project overlay ΓÇö rendered outside the canvas to avoid R3F namespace errors */}
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingRight: '8px' }}>
          <h2 style={{
            ...
            Rentra ΓÇô Flats &amp; Hostels Near You
          </h2>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {[
              ...
              <li key={i} style={{
                ...
                <span style={{ color: '#a855f7', flexShrink: 0, marginTop: '2px' }}>ΓÇó</span>
                <span>{text}</span>
              </li>
            ))}
          </ul>
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingRight: '8px' }}>
          <h2 style={{
            ...
            goCab ΓÇô Real-Time Cab Booking Web Application
          </h2>
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingRight: '8px' }}>
          <h2 style={{
            ...
            PDF Suite ΓÇô Web-based PDF Processing Platform
          </h2>
